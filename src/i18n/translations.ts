...
export const translations = {
  ...
  bookingForm: {
    sv: {
      ...
      savedSub: 'Städuppdraget har schemalagts och syns nu i kalendern.',
      whatsappBtn: 'Skicka WhatsApp-notis till städfirma nu',
      btnCreateAnother: '➕ Skapa en till bokning',
    ...
    en: {
      ...
      savedSub: 'The cleaning task has been scheduled and is now visible in the calendar.',
      whatsappBtn: 'Send WhatsApp notification to cleaning company now',
      btnCreateAnother: '➕ Create another booking',
    ...
    da: {
      ...
      savedSub: 'Rengøringsopgaven er planlagt og synlig i kalenderen.',
      whatsappBtn: 'Send WhatsApp-notifikation til rengøringsfirma nu',
      btnCreateAnother: '➕ Opret en ny booking',
    ...
    es: {
      ...
      savedSub: 'La tarea de limpieza se ha programado y ya se ve en el calendario.',
      whatsappBtn: 'Enviar notificación por WhatsApp ahora',
      btnCreateAnother: '➕ Crear otra reserva',
  ...
  incidentModal: {
    es: {
      title: 'Reportar foto / incidencia',
      subtitle: 'Solo si algo está roto, dañado o hay alguna incidencia.',
      labelPhotos: 'Fotos (Selecciona una o varias)',
      labelNote: 'Nota explicativa *',
      placeholderNote: 'Ej. Silla rota en terraza...',
      btnSave: 'Guardar reporte',
      photosCount: 'foto',
      photosCountPlural: 'fotos',
      savedTitle: '¡Reporte guardado con éxito!',
      savedSub: 'Puedes notificar inmediatamente a la anfitriona por WhatsApp:',
      btnNotifyWhatsApp: 'Avisar a la anfitriona por WhatsApp',
      btnDone: 'Cerrar',
    },
    en: {
      title: 'Report photo / incident',
      subtitle: 'Only if something is broken, damaged or there is an incident.',
      labelPhotos: 'Photos (Select one or multiple)',
      labelNote: 'Explanatory note *',
      placeholderNote: 'E.g. Broken chair on terrace...',
      btnSave: 'Save report',
      photosCount: 'photo',
      photosCountPlural: 'photos',
      savedTitle: 'Report saved successfully!',
      savedSub: 'You can notify the host immediately on WhatsApp:',
      btnNotifyWhatsApp: 'Notify host via WhatsApp',
      btnDone: 'Done',
    },
    sv: {
      title: 'Rapportera foto / skada',
      subtitle: 'Endast om något är trasigt, skadat eller avviker.',
      labelPhotos: 'Foton (Välj ett eller flera)',
      labelNote: 'Förklarande anteckning *',
      placeholderNote: 'T.ex. Trasig stol på terrassen...',
      btnSave: 'Spara rapport',
      photosCount: 'foto',
      photosCountPlural: 'foton',
      savedTitle: 'Rapporten har sparats!',
      savedSub: 'Du kan avisera värden direkt på WhatsApp nu:',
      btnNotifyWhatsApp: 'Avisera värden på WhatsApp',
      btnDone: 'Klart',
    },
    da: {
      title: 'Rapporter foto / skade',
      subtitle: 'Kun hvis noget er i stykker, beskadiget eller afviger.',
      labelPhotos: 'Fotos (Vælg et eller flere)',
      labelNote: 'Forklarende note *',
      placeholderNote: 'F.eks. Ødelagt stol på terrassen...',
      btnSave: 'Gem rapport',
      photosCount: 'foto',
      photosCountPlural: 'fotos',
      savedTitle: 'Rapporten er gemt!',
      savedSub: 'Du kan underrette værten direkte på WhatsApp nu:',
      btnNotifyWhatsApp: 'Underret vært på WhatsApp',
      btnDone: 'Færdig',
    },
  },
};